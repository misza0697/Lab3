...
public class SubroutineHierarchy extends JPanel {
	...
	private void drawWorld(Graphics2D g2) {
		...
		g2.translate(-0.9, 0);
		rotatingPolygone(g2);
		g2.translate(2.1, -0.8);
		rotatingPolygone(g2);
		g2.translate(-1.1, -2);
		
		g2.translate(-1.6, 4.5);
		//2 
		g2.scale(0.8, 0.8);
		...
		rotatingPolygone(g2);
		g2.translate(-1.7, 0.7);
		rotatingPolygone(g2);
		g2.translate(0.95, -2.7);
	
		g2.setColor(Color.GREEN);
		g2.scale(0.5, 1);
		g2.translate(-0.2, 1.2);
		filledTriangle(g2);
		g2.scale(2, 1);
		
		g2.setColor(Color.blue);
		g2.translate(-6.7, -1.7);
		g2.scale(1, 2);
		filledTriangle(g2);
		g2.scale(1, 0.5);
		g2.translate(6.5, 0);
	...
	private void rotatingPolygone(Graphics2D g2) { 
	...
	private static void filledPolygone(Graphics2D g2)
	{
		Path2D path = new Path2D.Double();  
		  path.moveTo(5,0);
		for(int i=1;i<8;i++)
		{ 
			path.lineTo(5* ( Math.cos(i*2* Math.PI / 8)), 5* ( Math.sin(i*2* Math.PI / 8)) );
