...
public class SceneGraph extends JPanel {
	...
	private void createWorld() {
        ...
        rotatingPolygon1.setTranslation(-0.74,0).setScale(0.05,0.05).setColor(Color.black);
        rotatingPolygon2.setTranslation(1.58,-0.82).setScale(0.05,0.05).setColor(Color.black);
        rotatingPolygon3.setTranslation(1.33,2.23).setScale(0.02,0.02).setColor(Color.black);
        rotatingPolygon4.setTranslation(2.7,1.75).setScale(0.02,0.02).setColor(Color.black);
        rotatingPolygon5.setTranslation(-1.6,1).setScale(0.04,0.04).setColor(Color.black);
        rotatingPolygon6.setTranslation(-3.24,1.6).setScale(0.04,0.04).setColor(Color.black);
        triangle1.setTranslation(0.38,-2.75).setScale(0.7,2.3).setColor(Color.BLUE);
        triangle2.setTranslation(-2.5,-0.4).setScale(0.5,1.7).setColor(Color.PINK);
        triangle3.setTranslation(1.98,0.64).setScale(0.5,1.3).setColor(Color.GREEN);
        
        rect1.setTranslation(0.4, -0.4).setScale(2.5, 0.15).setRotation(-20).setColor(Color.red);
        rect2.setTranslation(-2.45, 1.3).setScale(1.8, 0.1).setRotation(-20).setColor(Color.red);
        rect3.setTranslation(2, 2.0).setScale( 1.5, 0.1).setRotation(-20).setColor(Color.red);
	...
	public void updateFrame() {
		...
		rotatingPolygon3.setRotation(frameNumber*1.5); 
		rotatingPolygon4.setRotation(frameNumber*5); 
		rotatingPolygon5.setRotation(frameNumber*10); 
		rotatingPolygon6.setRotation(frameNumber*100); 
